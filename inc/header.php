...
$loginuser = $db->prepare("SELECT * FROM tb_user where username='$_SESSION[user]'");
$loginuser->execute();
...
<head>
    ...
    <title><?php if($page=='home'){
        echo $page='Halaman Utama';
    }else if($page=='perbaikan'){
        echo $page='Halaman Permintaan Perbaikan';
    }else{
        echo $page='Halaman Proses';
    }
    ?></title>
